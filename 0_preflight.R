...
cc_ref <- readr::read_csv(
  "../bipa2024_cartography/entity_codes/entity_codes.csv"
)
cc_geo <- readr::read_csv(
  "../bipa2024_cartography/entity_codes/entity_georegions.csv"
)
cc_wb <- readr::read_csv(
  "../bipa2024_cartography/entity_codes/entity_wb_classification23.csv"
)
